...
export function TypewriterEffectSmoothDemo() {
  const words = [
    ...
    {
      text: "Designcollab.",
      className: "text-indigo-700 dark:text-[#6810c1]",
    },
    {
      text: "", // Added the vertical bar
      className: "text-indigo-700 dark:text-[#6810c1]", // Same color as Agraphicart
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[40rem]">
      ...
      <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4">
        <button className="w-40 h-10 rounded-xl bg-black border-2 border-solid border-transparent text-white text-sm">
          Join now
        </button>
      </div>
